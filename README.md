...
Welcome to the Drone Autonomy Software repository of the Mars Rover Design Team (MRDT) at Missouri University of Science and Technology (Missouri S&T)! This repository contains the source code, documentation, and other resources for the development of the Drone Autonomy Software for our Mars Rover. The Drone Autonomy Software project aims to compete in the University Rover Challenge (URC) by demonstrating advanced autonomous capabilities and robust navigation algorithms.
...
#### [Drone_Autonomy_Software API Docs HERE](https://missourimrdt.github.io/Drone_Autonomy_Software/)
...
### To get started with our Drone Autonomy Software development, follow these steps:
...
#### 3. Clone the Drone Autonomy_Software repo:
