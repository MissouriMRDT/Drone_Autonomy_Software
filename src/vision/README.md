...
The **Vision** directory is intended to store C++ files related to computer vision and image processing functionalities in the Drone project. This directory focuses on algorithms and techniques used for visual perception and analysis.
...
5. **Pose estimation**: Files that estimate the 3D pose or position of objects or the Drone itself based on visual information.
...
Ensure that the vision-related code is properly integrated with other components of the project to enable visual perception and analysis for the Drone.
